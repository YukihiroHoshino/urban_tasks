...
FILE_PATHS = {
    ...
    'step1_fcd': '251027/data/try2_step1_fcd.xml',
    'step4_fcd': '251027/data/try2_step4_fcd.xml'
}
OUTPUT_HTML = '251027/fig/mfd_comparison_map_v7.html'
...
def calculate_mfd(processed_data, meshes):
    ...
    for mesh_name, time_slots in processed_data.items():
        ...
        for time_slot, values in time_slots.items():
            ...
            positive_speeds = [s for s in values['speeds'] if s > 0]
            speed_v_ms = hmean(positive_speeds) if positive_speeds else 0
