...
# --- 出力ファイル ---
rou_file_path = '250724/data/thursday_BRT_dropped_2.0.rou.xml'
...
if num_days == 0:
    ...
    num_truck_per_day = int(len(df_trucks) / num_days / ADAPT_RATE_TRUCK * 2.0)
    num_normal_per_day = int(len(df_normal) / num_days / ADAPT_RATE_NORMAL * 2.0)
