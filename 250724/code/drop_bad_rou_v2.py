...
# --- 入力ファイル ---
df = pandas.read_csv('250724/data/sunday_step1_saigai_matched.csv')
tree = ET.parse('250724/data/sunday_step1_saigai_out_nodes.xml')

# --- 出力ファイル ---
rou_file_path = '250724/data/sunday_step1_saigai_dropped.rou.xml'
