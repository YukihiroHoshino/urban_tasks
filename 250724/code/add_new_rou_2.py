...
#使用例
#df = pandas.read_csv('example_matched.csv')
#rou_root = ET.Element('routes')
#tree = ET.parse('./example_additional_out_nodes.xml')

#rou_file_path = './example_added.rou.xml'

#使用例
df = pandas.read_csv('250724/data/example_matched.csv')
rou_root = ET.Element('routes')
tree = ET.parse('250724/data/example_additional_out_nodes.xml')
