...
#使用例
#rou_file_path = './filename_additional_trips.rou.xml'
#edg_xml = ET.parse('./filename.edg.xml').getroot()

#使用例
rou_file_path = '250724/data/example_additional_trips.rou.xml'
edg_xml = ET.parse('250724/data/example.edg.xml').getroot()
