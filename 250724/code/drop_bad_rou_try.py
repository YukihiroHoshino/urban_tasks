...
# --- 入力ファイル ---
df = pandas.read_csv('250724/data/try_matched.csv')
tree = ET.parse('250724/data/try_out_nodes.xml')

# --- 出力ファイル ---
rou_file_path = '250724/data/try_dropped.rou.xml'

# ETC2.0の普及率を書き換え
ADAPT_RATE_TRUCK = 0.95
ADAPT_RATE_NORMAL = 0.95
